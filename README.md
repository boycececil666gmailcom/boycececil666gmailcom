...
|------------|-----------------|---------------|---------------|
| **Python** ![Python](https://img.shields.io/badge/Python-3776AB?style=flat-square&logo=python&logoColor=white) | Autonomous agents, desktop UIs, automation scripts. | 3 shipped projects · [readme-forge](https://github.com/boycececil666gmailcom/t1-python-super-amazing-readme-forge) · [daemon-git](https://github.com/boycececil666gmailcom/t1-python-daemon-git) · [huggingface](https://github.com/boycececil666gmailcom/t1-python-huggingface-transformer) | Started building tools to solve my own problems — automating repos, running local AI, shipping desktop apps. Python was the fastest path from idea to working software. |
