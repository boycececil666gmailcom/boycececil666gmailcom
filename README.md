...
|------------|-----------------|---------------|-----------------|
| **Python** ![Python](https://img.shields.io/badge/Python-3776AB?style=flat-square&logo=python&logoColor=white) | Build production automation tools | Rapid iteration with Python ecosystem | 4 shipped products, zero manual workflows |
