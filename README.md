...
### Level 4 — Proficient *(The Engineering Phase)*
> Optimizing systems, not just building them. Sees trade-offs in performance, cost, and scalability instinctively.

| Technology | Capability | Evidence |
|------------|-----------|----------|
| *—* | | |

### Level 3 — Real App Building *(The Production Phase)*
> Shipping code to real users. Architecture, deployment, resilience, and collaboration.

| Technology | Capability | Evidence |
|------------|-----------|----------|
| *—* | | |

### Level 2 — Prototype Building *(The Sandbox Phase)*
> Breaking free from tutorials. Building proof-of-concepts and learning how things wire together.
...
> Core syntax, terminology, and foundational concepts. Knowing what the tools are.
