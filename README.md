...
|------------|-----------------|---------------|---------------|
| **Python** ![Python](https://img.shields.io/badge/Python-3776AB?style=flat-square&logo=python&logoColor=white) | Autonomous agents, desktop UIs, automation scripts. | 3 shipped projects · [readme-forge](https://github.com/boycececil666gmailcom/t1-python-super-amazing-readme-forge) · [daemon-git](https://github.com/boycececil666gmailcom/t1-python-daemon-git) · [huggingface](https://github.com/boycececil666gmailcom/t1-python-huggingface-transformer) | Readme Forge, Daemon Git CLI, HuggingFace pipeline. |
| **C#** ![C#](https://img.shields.io/badge/C%23-239120?style=flat-square&logo=csharp&logoColor=white) | Gameplay logic, simulation systems, secure file pipelines. | 2 sim/game + 1 AES-256 vault · [hell-love](https://github.com/boycececil666gmailcom/t1-unity-hell-love) · [hrsim](https://github.com/boycececil666gmailcom/t1-unity-hrsim) · [vault-sync](https://github.com/boycececil666gmailcom/t1-csharp-vault-sync) | Unity architectures, .NET 9 file watcher → Google Drive. |
| **Unity** ![Unity](https://img.shields.io/badge/Unity-FFFFFF?style=flat-square&logo=unity&logoColor=black) | Real-time 3D simulation, ScriptableObject architectures. | 2 large-scale engine projects · [hell-love](https://github.com/boycececil666gmailcom/t1-unity-hell-love) · [hrsim](https://github.com/boycececil666gmailcom/t1-unity-hrsim) | Modular data flow for a game and a HR simulation. |
| **Blender** ![Blender](https://img.shields.io/badge/Blender-E87D0D?style=flat-square&logo=blender&logoColor=white) | Modeling, texturing, Python scripting, 3D rendering. | 2 visual pipelines · [blender-work](https://github.com/boycececil666gmailcom/t1-blender-3d-work) · [project-death](https://github.com/boycececil666gmailcom/t1-blender-project-death) | Procedural workflows, Geometry Nodes, Unreal/game assets. |
...
| **Git** ![Git](https://img.shields.io/badge/Git-F05032?style=flat-square&logo=git&logoColor=white) | Version control and automated cross-repo daemon syncing. | 20+ tracked/synced repos · [daemon-git](https://github.com/boycececil666gmailcom/t1-python-daemon-git) | Python daemon that batch-syncs all local repos. |
| **MCP** ![MCP](https://img.shields.io/badge/MCP-000000?style=flat-square&logo=anthropic&logoColor=white) | Bridging LLMs with local APIs, databases, and logic. | 1 full-stack MCP server · [mcp-todolist](https://github.com/boycececil666gmailcom/t1-mcp-todolist) | Hono REST API, Prisma ORM, Next.js client, Anthropic. |
| **Stable Diffusion** ![Stable Diffusion](https://img.shields.io/badge/Stable%20Diffusion-FF6B35?style=flat-square&logoColor=white) | Prompt-driven visual assets and LoRA pipelines. | 1 generative image pipeline · [huggingface](https://github.com/boycececil666gmailcom/t1-python-huggingface-transformer) | Local HuggingFace inference for visual reference automation. |
| **Godot** ![Godot](https://img.shields.io/badge/Godot-478CBF?style=flat-square&logo=godotengine&logoColor=white) | Rapid game prototyping, clean GDScript implementation. | 1 shipped gameplay demo · [project-wildcard](https://github.com/boycececil666gmailcom/t2-godot-project-wildcard) | Project Wildcard — node-based UI and deployment. |

### Tier 2 — Building Experience

| Technology | A (Achievement) | B (Backed By) | C (Came From) |
|------------|-----------------|---------------|---------------|
| **Unreal Engine** ![Unreal Engine](https://img.shields.io/badge/Unreal-0E1128?style=flat-square&logo=unrealengine&logoColor=white) | High-fidelity real-time 3D environments. | 1 visual simulation sandbox · [project-death](https://github.com/boycececil666gmailcom/t1-blender-project-death) | High-end rendering, 'Project Death' 3D concept. |
| **JavaScript** ![JavaScript](https://img.shields.io/badge/JavaScript-F7DF1E?style=flat-square&logo=javascript&logoColor=black) | Web client layers and WeChat Mini Programs. | 2 frontend repos · [hell-love-tcb](https://github.com/boycececil666gmailcom/t2-js-hell-love-tcb) · [mjdc](https://github.com/boycececil666gmailcom/t2-js-mjdc) | hellLove web client + MJDC WeChat mini program. |
| **ROS 2** ![ROS 2](https://img.shields.io/badge/ROS%202-22314E?style=flat-square&logo=ros&logoColor=white) | Autonomous robotic nodes and system topographies. | 1 containerized DevEnv · [ros-test](https://github.com/boycececil666gmailcom/t2-ros-test) | ROS 2 Humble bootstrap, hardware control flow analysis. |
| **Docker** ![Docker](https://img.shields.io/badge/Docker-2496ED?style=flat-square&logo=docker&logoColor=white) | Reproducible, volume-mounted environments. | 1 containerized robotics workspace · [ros-test](https://github.com/boycececil666gmailcom/t2-ros-test) | ROS 2 dependency isolation and simulation containers. |
