...
| Technology | A (Achievement) | B (Backed By) | C (Came From) | Work |
|------------|-----------------|---------------|---------------|------|
| **Python** ![Python](https://img.shields.io/badge/Python-3776AB?style=flat-square&logo=python&logoColor=white) | Autonomous agents, desktop UIs, automation scripts. | 3 shipped projects. | Readme Forge, Daemon Git CLI, HuggingFace pipeline. | [readme-forge](https://github.com/boycececil666gmailcom/t1-python-super-amazing-readme-forge) · [daemon-git](https://github.com/boycececil666gmailcom/t1-python-daemon-git) · [huggingface](https://github.com/boycececil666gmailcom/t1-python-huggingface-transformer) |
| **C#** ![C#](https://img.shields.io/badge/C%23-239120?style=flat-square&logo=csharp&logoColor=white) | Gameplay logic, simulation systems, secure file pipelines. | 2 sim/game projects + 1 AES-256 vault. | Unity architectures, .NET 9 file watcher → Google Drive. | [hell-love](https://github.com/boycececil666gmailcom/t1-unity-hell-love) · [hrsim](https://github.com/boycececil666gmailcom/t1-unity-hrsim) · [vault-sync](https://github.com/boycececil666gmailcom/t1-csharp-vault-sync) |
| **Unity** ![Unity](https://img.shields.io/badge/Unity-FFFFFF?style=flat-square&logo=unity&logoColor=black) | Real-time 3D simulation, ScriptableObject architectures. | 2 large-scale engine projects. | Modular data flow for a game and a HR simulation. | [hell-love](https://github.com/boycececil666gmailcom/t1-unity-hell-love) · [hrsim](https://github.com/boycececil666gmailcom/t1-unity-hrsim) |
| **Blender** ![Blender](https://img.shields.io/badge/Blender-E87D0D?style=flat-square&logo=blender&logoColor=white) | Modeling, texturing, Python scripting, 3D rendering. | 2 visual pipelines. | Procedural workflows, Geometry Nodes, Unreal/game assets. | [blender-work](https://github.com/boycececil666gmailcom/t1-blender-3d-work) · [project-death](https://github.com/boycececil666gmailcom/t1-blender-project-death) |
| **Photoshop** ![Photoshop](https://img.shields.io/badge/Photoshop-31A8FF?style=flat-square&logo=adobephotoshop&logoColor=white) | Game textures, UI assets, visual polish. | Multi-project UI pipelines. | Texture painting, sprites for web and Unity clients. | — |
| **Git** ![Git](https://img.shields.io/badge/Git-F05032?style=flat-square&logo=git&logoColor=white) | Version control and automated cross-repo daemon syncing. | 20+ tracked/synced repos. | Python daemon that batch-syncs all local repos. | [daemon-git](https://github.com/boycececil666gmailcom/t1-python-daemon-git) |
| **MCP** ![MCP](https://img.shields.io/badge/MCP-000000?style=flat-square&logo=anthropic&logoColor=white) | Bridging LLMs with local APIs, databases, and logic. | 1 full-stack MCP server. | Hono REST API, Prisma ORM, Next.js client, Anthropic. | [mcp-todolist](https://github.com/boycececil666gmailcom/t1-mcp-todolist) |
| **Stable Diffusion** ![Stable Diffusion](https://img.shields.io/badge/Stable%20Diffusion-FF6B35?style=flat-square&logoColor=white) | Prompt-driven visual assets and LoRA pipelines. | 1 generative image pipeline. | Local HuggingFace inference for visual reference automation. | [huggingface](https://github.com/boycececil666gmailcom/t1-python-huggingface-transformer) |
| **Godot** ![Godot](https://img.shields.io/badge/Godot-478CBF?style=flat-square&logo=godotengine&logoColor=white) | Rapid game prototyping, clean GDScript implementation. | 1 shipped gameplay demo. | Project Wildcard — node-based UI and deployment. | [project-wildcard](https://github.com/boycececil666gmailcom/t2-godot-project-wildcard) |

### Tier 2 — Building Experience

| Technology | A (Achievement) | B (Backed By) | C (Came From) | Work |
|------------|-----------------|---------------|---------------|------|
| **Unreal Engine** ![Unreal Engine](https://img.shields.io/badge/Unreal-0E1128?style=flat-square&logo=unrealengine&logoColor=white) | High-fidelity real-time 3D environments. | 1 visual simulation sandbox. | High-end rendering, 'Project Death' 3D concept. | [project-death](https://github.com/boycececil666gmailcom/t1-blender-project-death) |
| **JavaScript** ![JavaScript](https://img.shields.io/badge/JavaScript-F7DF1E?style=flat-square&logo=javascript&logoColor=black) | Web client layers and WeChat Mini Programs. | 2 frontend repos. | hellLove web client + MJDC WeChat mini program. | [hell-love-tcb](https://github.com/boycececil666gmailcom/t2-js-hell-love-tcb) · [mjdc](https://github.com/boycececil666gmailcom/t2-js-mjdc) |
| **ROS 2** ![ROS 2](https://img.shields.io/badge/ROS%202-22314E?style=flat-square&logo=ros&logoColor=white) | Autonomous robotic nodes and system topographies. | 1 containerized DevEnv. | ROS 2 Humble bootstrap, hardware control flow analysis. | [ros-test](https://github.com/boycececil666gmailcom/t2-ros-test) |
| **Docker** ![Docker](https://img.shields.io/badge/Docker-2496ED?style=flat-square&logo=docker&logoColor=white) | Reproducible, volume-mounted environments. | 1 containerized robotics workspace. | ROS 2 dependency isolation and simulation containers. | [ros-test](https://github.com/boycececil666gmailcom/t2-ros-test) |
| **HTML / CSS** ![HTML](https://img.shields.io/badge/HTML5-E34F26?style=flat-square&logo=html5&logoColor=white) | Responsive layouts, scalable UI frames, DOM logic. | Daily professional engineering. | Frontend Engineer at Thundersoft + personal web work. | — |

### Tier 3 — Exploring

| Technology | A (Achievement / Exploring) | B (Backed By) | C (Came From) | Work |
|------------|-----------------------------|---------------|---------------|------|
| **Ethereum** ![Ethereum](https://img.shields.io/badge/Ethereum-3C3C3D?style=flat-square&logo=ethereum&logoColor=white) | Web3 protocols and smart contract foundations. | Ongoing research. | Decentralized network architectures, blockchain paradigms. | — |
| **Raspberry Pi** ![Raspberry Pi](https://img.shields.io/badge/Raspberry%20Pi-A22846?style=flat-square&logo=raspberrypi&logoColor=white) | Embedded Linux, headless server setup. | Hardware prototyping. | Software intelligence bridged to physical boards. | — |
| **STM32** ![STM32](https://img.shields.io/badge/STM32-03234B?style=flat-square&logo=stmicroelectronics&logoColor=white) | Low-level MCU programming / GPIO control. | Embedded hardware research. | Bare-metal foundations for robot motor control. | — |
