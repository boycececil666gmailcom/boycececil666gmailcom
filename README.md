...
| **Unity** ![Unity](https://img.shields.io/badge/Unity-FFFFFF?style=flat-square&logo=unity&logoColor=black) | Real-time 3D simulation, ScriptableObject architectures. | 2 large-scale engine projects · [hell-love](https://github.com/boycececil666gmailcom/t1-unity-hell-love) · [hrsim](https://github.com/boycececil666gmailcom/t1-unity-hrsim) | Wanted to build games from scratch and own the full stack. Unity gave me the fastest path from concept to a running 3D world, and I kept going deeper into its architecture. |
| **Blender** ![Blender](https://img.shields.io/badge/Blender-E87D0D?style=flat-square&logo=blender&logoColor=white) | Modeling, texturing, Python scripting, 3D rendering. | 2 visual pipelines · [blender-work](https://github.com/boycececil666gmailcom/t1-blender-3d-work) · [project-death](https://github.com/boycececil666gmailcom/t1-blender-project-death) | Needed 3D assets I couldn't find elsewhere. Learned Blender to own the full pipeline — from concept to in-engine asset — without depending on anyone else. |
...
| Technology | A (Achievement) | B (Backed By) | C (Came From) |
|------------|-----------------|---------------|---------------|
| **Unreal Engine** ![Unreal Engine](https://img.shields.io/badge/Unreal-0E1128?style=flat-square&logo=unrealengine&logoColor=white) | High-fidelity real-time 3D environments. | 1 visual simulation sandbox · [project-death](https://github.com/boycececil666gmailcom/t1-blender-project-death) | Pulled in by the visual ceiling — for production-quality 3D, Blender alone isn't enough. Learning Unreal to stage and render environments at a level that actually looks real. |
