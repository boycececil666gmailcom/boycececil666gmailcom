...
|------------|-----------------|---------------|---------------|
| **Python** ![Python](https://img.shields.io/badge/Python-3776AB?style=flat-square&logo=python&logoColor=white) | Autonomous agents, desktop UIs, automation scripts, system daemons. | 4 shipped projects · [readme-forge](https://github.com/boycececil666gmailcom/t1-python-super-amazing-readme-forge) · [daemon-git](https://github.com/boycececil666gmailcom/t1-python-daemon-git) · [huggingface](https://github.com/boycececil666gmailcom/t1-python-huggingface-transformer) · [argus](https://github.com/boycececil666gmailcom/t1-argus) | Started building tools to solve my own problems — automating repos, running local AI, shipping desktop apps. Python was the fastest path from idea to working software. |
| **C#** ![C#](https://img.shields.io/badge/C%23-239120?style=flat-square&logo=csharp&logoColor=white) | Gameplay logic, simulation systems, secure file pipelines. | 2 sim/game + 1 AES-256 vault · [hell-love](https://github.com/boycececil666gmailcom/t1-unity-hell-love) · [hrsim](https://github.com/boycececil666gmailcom/t1-unity-hrsim) · [vault-sync](https://github.com/boycececil666gmailcom/t1-csharp-vault-sync) | Chose Unity for game dev, which meant C#. Grew from gameplay scripts into full simulation architectures and .NET server-side tooling — C# turned out to be far more powerful than I expected. |
| **Unity** ![Unity](https://img.shields.io/badge/Unity-FFFFFF?style=flat-square&logo=unity&logoColor=black) | Real-time graphics simulation, ScriptableObject architectures. | 2 large-scale engine projects · [hell-love](https://github.com/boycececil666gmailcom/t1-unity-hell-love) · [hrsim](https://github.com/boycececil666gmailcom/t1-unity-hrsim) | Wanted to build games from scratch and own the full stack. Unity gave me the fastest path from concept to a running world, and I kept going deeper into its architecture. |
| **Blender** ![Blender](https://img.shields.io/badge/Blender-E87D0D?style=flat-square&logo=blender&logoColor=white) | Modeling, texturing, Python scripting, graphics rendering. | 2 visual pipelines · [blender-work](https://github.com/boycececil666gmailcom/t1-blender-3d-work) · [project-death](https://github.com/boycececil666gmailcom/t1-blender-project-death) | Needed graphics assets I couldn't find elsewhere. Learned Blender to own the full pipeline — from concept to in-engine asset — without depending on anyone else. |
| **Graphics Programming** ![Graphics](https://img.shields.io/badge/Graphics_Programming-CF222E?style=flat-square&logoColor=white) | Shader authoring, render pipeline customization, real-time visual systems. | Built across Unity, Unreal, and Blender · [hell-love](https://github.com/boycececil666gmailcom/t1-unity-hell-love) · [blender-work](https://github.com/boycececil666gmailcom/t1-blender-3d-work) · [project-death](https://github.com/boycececil666gmailcom/t1-blender-project-death) | The visual layer is what separates good software from memorable experiences. Grew through Unity shaders, Blender material nodes, and Unreal rendering — pushing toward deeper GPU and real-time pipeline control. |
...
| Technology | A (Achievement) | B (Backed By) | C (Came From) |
|------------|-----------------|---------------|---------------|
| **Unreal Engine** ![Unreal Engine](https://img.shields.io/badge/Unreal-0E1128?style=flat-square&logo=unrealengine&logoColor=white) | High-fidelity real-time graphics environments. | 1 visual simulation sandbox · [project-death](https://github.com/boycececil666gmailcom/t1-blender-project-death) | Pulled in by the visual ceiling — for production-quality graphics, Blender alone isn't enough. Learning Unreal to stage and render environments at a level that actually looks real. |
| **JavaScript** ![JavaScript](https://img.shields.io/badge/JavaScript-F7DF1E?style=flat-square&logo=javascript&logoColor=black) | Web client layers and WeChat Mini Programs. | 2 frontend repos · [hell-love-tcb](https://github.com/boycececil666gmailcom/t2-js-hell-love-tcb) · [mjdc](https://github.com/boycececil666gmailcom/t2-js-mjdc) | Needed a web layer for hellLove and a WeChat mini program for a real client — JS was the only path to ship those. Daily work at Thundersoft keeps sharpening it further. |
| **ROS 2** ![ROS 2](https://img.shields.io/badge/ROS%202-22314E?style=flat-square&logo=ros&logoColor=white) | Autonomous robotic nodes and system topographies. | 1 containerized DevEnv · [ros-test](https://github.com/boycececil666gmailcom/t2-ros-test) | Robotics is where software meets the physical world. Learning ROS 2 to design autonomous systems and understand how real robots are architected — not just simulated. |
| **Docker** ![Docker](https://img.shields.io/badge/Docker-2496ED?style=flat-square&logo=docker&logoColor=white) | Reproducible, volume-mounted environments. | 1 containerized robotics workspace · [ros-test](https://github.com/boycececil666gmailcom/t2-ros-test) | Learned through ROS 2 — containerizing a complex robotics environment taught me why reproducible setups matter for any serious engineering work, not just robotics. |
